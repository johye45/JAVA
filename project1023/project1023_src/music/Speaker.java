...
부모클래스가 불완전한 추상클래스 인 경우 , 이건 재산이 아니라
빚더미다 즉, 부모의 추상적인 메서드의 완성을
자식에게 떠넘긴 것임
따라서 자식클래스에서는, 부모의 불완전한 메서드를
완전히 재정의 해야, 이 클래스가 완전한 클래스가 된다
